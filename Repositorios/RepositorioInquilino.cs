...
namespace Inmobiliaria_.Net.Repositorios
{
    public class RepositorioInquilino
    {
        ...
        public IList<Inquilino> ListarInquilinos()
        {
            ...
            {
                var sql =
                    @$"Select {nameof(Inquilino.Id_inquilino)}, {nameof(Inquilino.Nombre)}, {nameof(Inquilino.Apellido)}, 
        ...
        public int GuardarNuevo(Inquilino inquilino)
        {
            ...
            {
                var sql =
                    @$"INSERT INTO inquilino ({nameof(Inquilino.Nombre)}, {nameof(Inquilino.Apellido)}, 
